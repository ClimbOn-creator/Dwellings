...
class MarketplaceService {
  ...
  static const cities = [
    ...
    MarketplaceCity('Central Saanich', 'BC', 'CA'),
    ...
    MarketplaceCity('Highlands', 'BC', 'CA'),
    MarketplaceCity('Kamloops', 'BC', 'CA'),
    MarketplaceCity('Victoria', 'BC', 'CA'),
    MarketplaceCity('Kelowna', 'BC', 'CA'),
    MarketplaceCity('Langley', 'BC', 'CA'),
    MarketplaceCity('Lions Bay', 'BC', 'CA'),
    MarketplaceCity('Maple Ridge', 'BC', 'CA'),
    MarketplaceCity('Metchosin', 'BC', 'CA'),
    MarketplaceCity('Nanaimo', 'BC', 'CA'),
    MarketplaceCity('Nelson', 'BC', 'CA'),
    MarketplaceCity('New Westminster', 'BC', 'CA'),
    MarketplaceCity('North Saanich', 'BC', 'CA'),
    MarketplaceCity('North Vancouver', 'BC', 'CA'),
    MarketplaceCity('Oak Bay', 'BC', 'CA'),
    MarketplaceCity('Penticton', 'BC', 'CA'),
    MarketplaceCity('Port Coquitlam', 'BC', 'CA'),
    MarketplaceCity('Port Moody', 'BC', 'CA'),
    MarketplaceCity('Prince George', 'BC', 'CA'),
    MarketplaceCity('Prince Rupert', 'BC', 'CA'),
    MarketplaceCity('Richmond', 'BC', 'CA'),
    MarketplaceCity('Saanich', 'BC', 'CA'),
    MarketplaceCity('Sidney', 'BC', 'CA'),
    MarketplaceCity('Sooke', 'BC', 'CA'),
    MarketplaceCity('Squamish', 'BC', 'CA'),
    MarketplaceCity('Surrey', 'BC', 'CA'),
    MarketplaceCity('Terrace', 'BC', 'CA'),
    MarketplaceCity('Vernon', 'BC', 'CA'),
    MarketplaceCity('View Royal', 'BC', 'CA'),
    MarketplaceCity('West Vancouver', 'BC', 'CA'),
    MarketplaceCity('Whistler', 'BC', 'CA'),
    MarketplaceCity('White Rock', 'BC', 'CA'),
    MarketplaceCity('Anmore', 'BC', 'CA'),
    MarketplaceCity('Belcarra', 'BC', 'CA'),
    MarketplaceCity('Bowen Island', 'BC', 'CA'),
    MarketplaceCity('Colwood', 'BC', 'CA'),
    MarketplaceCity('Delta', 'BC', 'CA'),
    MarketplaceCity('Esquimalt', 'BC', 'CA'),
    MarketplaceCity('Langford', 'BC', 'CA'),
    MarketplaceCity('Pitt Meadows', 'BC', 'CA'),
    MarketplaceCity('Calgary', 'AB', 'CA'),
    MarketplaceCity('Airdrie', 'AB', 'CA'),
    MarketplaceCity('Banff', 'AB', 'CA'),
    MarketplaceCity('Canmore', 'AB', 'CA'),
    MarketplaceCity('Chestermere', 'AB', 'CA'),
    MarketplaceCity('Cochrane', 'AB', 'CA'),
    MarketplaceCity('Crossfield', 'AB', 'CA'),
    MarketplaceCity('Diamond Valley', 'AB', 'CA'),
    MarketplaceCity('Edmonton', 'AB', 'CA'),
    MarketplaceCity('Fort McMurray', 'AB', 'CA'),
    MarketplaceCity('Grande Prairie', 'AB', 'CA'),
    MarketplaceCity('High River', 'AB', 'CA'),
    MarketplaceCity('Lethbridge', 'AB', 'CA'),
    MarketplaceCity('Medicine Hat', 'AB', 'CA'),
    MarketplaceCity('Okotoks', 'AB', 'CA'),
    MarketplaceCity('Rocky View County', 'AB', 'CA'),
    MarketplaceCity('Foothills County', 'AB', 'CA'),
    MarketplaceCity('Strathmore', 'AB', 'CA'),
    MarketplaceCity('Red Deer', 'AB', 'CA'),
    MarketplaceCity('Toronto', 'ON', 'CA'),
    MarketplaceCity('Ajax', 'ON', 'CA'),
    MarketplaceCity('Aurora', 'ON', 'CA'),
    ...
    MarketplaceCity('Caledon', 'ON', 'CA'),
    MarketplaceCity('Clarington', 'ON', 'CA'),
    MarketplaceCity('East Gwillimbury', 'ON', 'CA'),
    MarketplaceCity('Georgina', 'ON', 'CA'),
    MarketplaceCity('Guelph', 'ON', 'CA'),
    MarketplaceCity('Ottawa', 'ON', 'CA'),
    MarketplaceCity('Hamilton', 'ON', 'CA'),
    MarketplaceCity('Halton Hills', 'ON', 'CA'),
    MarketplaceCity('Kingston', 'ON', 'CA'),
    MarketplaceCity('King', 'ON', 'CA'),
